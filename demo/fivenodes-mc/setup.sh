...
docker exec node2 sh -c "fcr cidnet serving serve 0 $cid2_1 1"
docker exec node2 sh -c "fcr cidnet serving serve 0 $cid2_2 1"
...
docker exec node3 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet4 10000000000000 $addr4"
...
docker exec node3 sh -c "fcr paynet serving serve 0 $wallet4 5 100"
