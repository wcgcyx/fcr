...
# Start serving cids
docker exec node0 sh -c "fcr cidnet serving serve 0 $cid0 1"
docker exec node1 sh -c "fcr cidnet serving serve 0 $cid1 1"
docker exec node2 sh -c "fcr cidnet serving serve 0 $cid2 1"
docker exec node3 sh -c "fcr cidnet serving serve 0 $cid3 1"
docker exec node4 sh -c "fcr cidnet serving serve 0 $cid4 1"
docker exec node5 sh -c "fcr cidnet serving serve 0 $cid5 1"
docker exec node6 sh -c "fcr cidnet serving serve 0 $cid6 1"
docker exec node7 sh -c "fcr cidnet serving serve 0 $cid7 1"
docker exec node8 sh -c "fcr cidnet serving serve 0 $cid8 1"
docker exec node9 sh -c "fcr cidnet serving serve 0 $cid9 1"
...
wallet0=$(docker exec node0 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet1=$(docker exec node1 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet2=$(docker exec node2 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet3=$(docker exec node3 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet4=$(docker exec node4 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet5=$(docker exec node5 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet6=$(docker exec node6 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet7=$(docker exec node7 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet8=$(docker exec node8 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
wallet9=$(docker exec node9 sh -c "fcr paynet root 0" | cut -d ":" -f2 | xargs | tr -dc '[[:print:]]')
...
docker exec node0 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet1 10000000000000 $addr1"
docker exec node1 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet2 10000000000000 $addr2"
docker exec node1 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet4 10000000000000 $addr4"
docker exec node1 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet6 10000000000000 $addr6"
docker exec node2 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet3 10000000000000 $addr3"
docker exec node3 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet0 10000000000000 $addr0"
docker exec node4 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet5 10000000000000 $addr5"
docker exec node4 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet7 10000000000000 $addr7"
docker exec node5 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet2 10000000000000 $addr2"
docker exec node6 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet7 10000000000000 $addr7"
docker exec node7 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet8 10000000000000 $addr8"
docker exec node8 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet5 10000000000000 $addr5"
docker exec node8 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet9 10000000000000 $addr9"
docker exec node9 sh -c "(echo yes) | fcr paynet outbound create 0 $wallet8 10000000000000 $addr8"
# Start serving channels
docker exec node0 sh -c "fcr paynet serving serve 0 $wallet1 5 100"
docker exec node1 sh -c "fcr paynet serving serve 0 $wallet2 5 100"
docker exec node1 sh -c "fcr paynet serving serve 0 $wallet4 5 100"
docker exec node1 sh -c "fcr paynet serving serve 0 $wallet6 5 100"
docker exec node2 sh -c "fcr paynet serving serve 0 $wallet3 5 100"
docker exec node3 sh -c "fcr paynet serving serve 0 $wallet0 5 100"
docker exec node4 sh -c "fcr paynet serving serve 0 $wallet5 5 100"
docker exec node4 sh -c "fcr paynet serving serve 0 $wallet7 5 100"
docker exec node5 sh -c "fcr paynet serving serve 0 $wallet2 5 100"
docker exec node6 sh -c "fcr paynet serving serve 0 $wallet7 5 100"
docker exec node7 sh -c "fcr paynet serving serve 0 $wallet8 5 100"
docker exec node8 sh -c "fcr paynet serving serve 0 $wallet5 5 100"
docker exec node8 sh -c "fcr paynet serving serve 0 $wallet9 5 100"
docker exec node9 sh -c "fcr paynet serving serve 0 $wallet8 5 100"
